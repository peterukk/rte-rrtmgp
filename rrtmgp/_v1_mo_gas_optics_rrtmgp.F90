...
contains
  ...
  function gas_optics_int(this,                             &
    ...
    ! output
    !! EDITS !!
    real(wp),    dimension(:,:,:), intent(  out) :: col_gas
...
function compute_gas_taus(this,                       &
    ...
    optical_props,              &
    jtemp, jpress, jeta, tropo, fmajor, &
    col_dry, col_gas) result(error_msg)
...
real(wp), dimension(ncol,nlay,0:size(this%gas_names)), intent(out), optional :: col_gas ! column amounts for each gas, plus col_dry
