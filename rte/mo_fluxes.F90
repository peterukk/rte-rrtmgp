...
module mo_fluxes
  ...
  !   Data components are contiguous, pointers so results can be written directly into memory
  !
  ! -----------------------------------------------------------------------------------------------
  ...
  ! -----------------------------------------------------------------------------------------------
  ! More generic class which includes contiguous, pointers to g-point fluxes, which may or may not be used/needed
